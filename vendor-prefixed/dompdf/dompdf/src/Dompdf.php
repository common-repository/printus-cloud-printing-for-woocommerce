...
use DOMXPath;
use Printus\Dompdf\Frame\Factory;
use Printus\Dompdf\Frame\FrameTree;
use Printus\Dompdf\Image\Cache;
use Printus\Dompdf\Css\Stylesheet;
use Printus\Dompdf\Helpers;
use Printus\Masterminds\HTML5;
...
class Dompdf
{
    ...
    */
    ...
    /**
     * Return the underlying Canvas instance (e.g. Printus\Dompdf\Adapter\CPDF, Printus\Dompdf\Adapter\GD)
     *
     * @return Canvas
     */
