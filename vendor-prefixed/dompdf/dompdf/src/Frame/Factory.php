 ...
 */
namespace Printus\Dompdf\Frame;
...
use Printus\Dompdf\FrameDecorator\Page as PageFrameDecorator;
use Printus\Dompdf\FrameReflower\Page as PageFrameReflower;
use Printus\Dompdf\Positioner\AbstractPositioner;
use DOMXPath;
...
class Factory
{
    ...
    public static function decorate_frame(Frame $frame, Dompdf $dompdf, ?Frame $root = null): ?AbstractFrameDecorator
    {
        ...
        $decorator  = "Printus\Dompdf\\FrameDecorator\\$decorator";
        $reflower   = "Printus\Dompdf\\FrameReflower\\$reflower";
    ...
    protected static function getPositionerInstance(string $type): AbstractPositioner
    {
        if (!isset(self::$_positioners[$type])) {
            $class = '\\Printus\\Dompdf\\Positioner\\'.$type;
