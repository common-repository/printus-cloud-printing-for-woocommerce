...
namespace Printus\Dompdf\Adapter;

use Printus\Dompdf\Canvas;
use Printus\Dompdf\Dompdf;
use Printus\Dompdf\Exception;
use Printus\Dompdf\FontMetrics;
use Printus\Dompdf\Helpers;
use Printus\Dompdf\Image\Cache;
...
class CPDF implements Canvas
{
    ...
    public function __construct($paper = "letter", string $orientation = "portrait", ?Dompdf $dompdf = null)
    {
        ...
        $this->_pdf = new \Printus\Dompdf\Cpdf(
            $size,
            true,
    ...
    public function select($x, $y, $w, $h, $font, $size, $color = [0, 0, 0], $opts = [])
    {
        ...
        $ft = \Printus\Dompdf\Cpdf::ACROFORM_FIELD_CHOICE;
        $ff = \Printus\Dompdf\Cpdf::ACROFORM_FIELD_CHOICE_COMBO;
    ...
    public function textarea($x, $y, $w, $h, $font, $size, $color = [0, 0, 0])
    {
        ...
        $ft = \Printus\Dompdf\Cpdf::ACROFORM_FIELD_TEXT;
        $ff = \Printus\Dompdf\Cpdf::ACROFORM_FIELD_TEXT_MULTILINE;
    ...
    public function input($x, $y, $w, $h, $type, $font, $size, $color = [0, 0, 0])
    {
        ...
        switch ($type) {
            ...
            case 'password':
                $ft = \Printus\Dompdf\Cpdf::ACROFORM_FIELD_TEXT;
                $ff = \Printus\Dompdf\Cpdf::ACROFORM_FIELD_TEXT_PASSWORD;
                break;
            case 'submit':
                $ft = \Printus\Dompdf\Cpdf::ACROFORM_FIELD_BUTTON;
                break;
        }
