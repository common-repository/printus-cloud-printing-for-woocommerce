...
class Style
{
    ...
    public function fromStyleSheets(AbstractTag $tag, $attributes) {
        ...
        foreach ($stylesheets as $_sc) {
            ...
            /** @var \Printus\Sabberworm\CSS\RuleSet\DeclarationBlock $_decl */
            foreach ($_sc->getAllDeclarationBlocks() as $_decl) {

                /** @var \Printus\Sabberworm\CSS\Property\Selector $_selector */
                foreach ($_decl->getSelectors() as $_selector) {
                    ...
                    if ($class !== null) {
                        foreach ($class as $_class) {
                            if ($_selector === ".$_class") {
                                /** @var \Printus\Sabberworm\CSS\Rule\Rule $_rule */
