...
if ( ! class_exists( 'Printus_WordPressSettingsFramework' ) ) {
	/**
	 * Printus_WordPressSettingsFramework class
	 */
	class Printus_WordPressSettingsFramework {
		/**
		 * Settings wrapper.
		 *
		 * @var array
		...
		/**
		 * Printus_WordPressSettingsFramework constructor.
		 *
